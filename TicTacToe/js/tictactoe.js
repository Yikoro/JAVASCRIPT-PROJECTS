...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //squareNumber and activePlayer are conca together and added to array.
        selectedSquares.push(squareNumber + activePlayer);
        //This calls a function to check for any win conditions.
        checkWinConditions();
        //This condition is forn changing the active player.
        if (activePlayer === 'X') {
    ...
    function computersTurn() {
        ...
        while (!success) {
            //A tandom number between 0 and 8 is selected.
...
function checkWinConditions() {
    ...
    //O 0, 4, 8 condition
    else if (arrayIncludes('0O', '40', '8O')) { drawWinLine(100, 100, 520, 520) }
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 varibles we pass are all included in our array then
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        y = y1;
        //This function interats with the canvas
        function animateLineDrawing() {
            ...
            c.stroke();
            //This condtion checks if we've reached the endpoints.
            if (x1 <= x2 && y1 <= y2) {
